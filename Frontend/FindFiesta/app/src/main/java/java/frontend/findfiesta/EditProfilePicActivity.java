...
/**
 * class that holds the functionality for the edit profile picture page
 */
public class EditProfilePicActivity extends AppCompatActivity implements WebSocketListener1{
    ...
    Button selectBtn;
    /**
     * image view of the current profile picture
     */
    ...
    /**
     * holds current photo path
     */
    String currentPhotoPath;

    /**
     * back button to last page
     */
    Button backButton;

    /**
     * button to choose the camera
     */
    ...
    /**
     * int for requesting image by gallery
     */
    private static final int REQUEST_GALLERY_ACCESS = 1;

    /**
     * int for requesting image by camera
     */
    private static final int REQUEST_IMAGE_CAPTURE = 2;

    // replace this with the actual address
    // 10.0.2.2 to be used for localhost if running springboot on the same host
    private static String UPLOAD_URL = "http://coms-309-040.class.las.iastate.edu:8080/profile_images/" + Actor.getCurrentId();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_editprofilepic);
        ...
        WebSocketManagerNotifs.getInstanceNotifs().setWebSocketListener(EditProfilePicActivity.this);

        UPLOAD_URL = "http://coms-309-040.class.las.iastate.edu:8080/profile_images/" + Actor.getCurrentId();

        profilePic = findViewById(R.id.profilePicture);
        selectBtn = findViewById(R.id.selectBtn);
        backButton = findViewById(R.id.backbutton20);
...
//        uploadBtn.setOnClickListener(v -> uploadImage());
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(EditProfilePicActivity.this, AccountActivity.class));
            }
        });
...
//                        startActivityForResult(intent, 2);
        ...
        deleteButton = findViewById(R.id.deletePicButton);
    ...
    /**
     * a camera method that works with URI for the file and starts needed activity
     */
    ...
    /**
     * creates an image file. Backend handles distinguishing with different file names upon creation.
     */
...
//        File storageDir = getExternalFilesDir(Environment.DIRECTORY_PICTURES); //use if not adding pic to camera roll
        File storageDir = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES); //use to add pic to camera roll
...
//                        profilePic.setImageBitmap(response);
    ...
    /**
     * called automatically from starting activity with camera and camera roll.
     * button. Instantly changes the profile picture to the photo taken by the camera.
     * Instantly uploads from camera or from selected from camera roll so a separate
     * upload button is now unnecessary.
     *
     * @param requestCode
     * @param resultCode
     * @param data
...
//                notesEdit.setText(currentPhotoPath);
            }
        }
        ...
        //calling upload here automatically uploads them so we don't need an upload button
        uploadImage();
    }
        ...
        JsonObjectRequest request = new JsonObjectRequest(
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        Toast.makeText(EditProfilePicActivity.this, "Image deleted", Toast.LENGTH_LONG).show();
                        return;
                    }
                },
                new Response.ErrorListener() {
    ...
    public void onWebSocketMessage(String message) {
       ...
       runOnUiThread(new Runnable() {
           @Override
           public void run() {
               Toast.makeText(EditProfilePicActivity.this, message + "", Toast.LENGTH_SHORT).show();
           }
       });
